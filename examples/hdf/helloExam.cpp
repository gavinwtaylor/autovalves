 ...
 * in    *
 * the COPYING file, which can be found at the root of the source
 * code       *
 * distribution tree, or in
 * https://support.hdfgroup.org/ftp/HDF5/releases.  *
 * If you do not have access to either file, you may request a copy
 * from     *
 * help@hdfgroup.org.
 * *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
int main (void)
{
  ...
  try
  {
    // Turn off the auto-printing when failure occurs so that we
    // can
